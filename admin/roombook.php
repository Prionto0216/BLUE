						...
						if(isset($_POST['co']))
						{
							...
							if($st=="Confirm")
							{
								...
								if($f1=="NO" )
								{
									...
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Double Bed')</script>";

									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Single Bed')</script>";
									}
										else if($f4=="NO")
										{
										...
										else if( mysqli_query($con,$urb))
											{
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;
														...
														else if($troom=="Double Bed")
														{
															$type_of_room = 180;
														}
														else if($troom=="Single Bed")
														{
															$type_of_room = 150;
														}
